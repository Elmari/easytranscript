...
import static de.ewerkzeug.easytranscript.core.Variables.millisecondsPerStep;
import static de.ewerkzeug.easytranscript.core.Variables.player;
import static de.ewerkzeug.easytranscript.core.Variables.prop;
import static de.ewerkzeug.easytranscript.core.Variables.useFXPlayer;
...
public class TunerDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
     ...
     //   TunerPanel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        TunerrateSlider.setMaximum(Variables.maxPlayerRate);
        ...
        if (!useFXPlayer) {
            if (player.isMediaLoaded()) {
                if (millisecondsPerStep != TunerrateSlider.getValue() / 10) {
                    ...
                    Variables.currentPlayerTime = easytranscript.getMainSlider().getValue() * 1000;
