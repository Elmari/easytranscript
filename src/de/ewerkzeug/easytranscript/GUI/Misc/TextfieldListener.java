...
import static de.ewerkzeug.easytranscript.Core.V.casChanged;
...
// !--- Suggestion List Teil
    ...
    public void removeUpdate(DocumentEvent e) {
        ...
        if (de.ewerkzeug.easytranscript.Core.V.insertionMode != Mode.COMPLETION) {
/*
    ...
    private class CompletionTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                doc.insertString(position, completion, V.currentAttributeSet);
                ...
                de.ewerkzeug.easytranscript.Core.V.insertionMode = Mode.COMPLETION;
