...
import static de.ewerkzeug.easytranscript.Core.V.fontDropDown;
...
public class CaretPositionInformation extends SwingWorker<String, Object> {
    ...
    public String doInBackground() {
        ...
        fontSize = Integer.parseInt(attr.getAttribute(StyleConstants.FontSize).toString()) - V.performanceModeFontSizeIncrease;
        if (fontSize<8){
            fontSize=12;
            StyleConstants.setFontSize(currentAttributeSet, 12+V.performanceModeFontSizeIncrease);
          //  V.casChanged=true;
        }
        ...
        for (int i = easytranscript.getMainCenterEditorEditorPane().getSelectionStart(); i < easytranscript.getMainCenterEditorEditorPane().getSelectionEnd() - 1; i++) {
            ...
            int fontSizeEnd_N = Integer.parseInt(attr.getAttribute(StyleConstants.FontSize).toString()) - V.performanceModeFontSizeIncrease;
