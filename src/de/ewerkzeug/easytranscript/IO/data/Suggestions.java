...
import static de.ewerkzeug.easytranscript.core.Variables.suggestionNeededLength;
import java.io.File;
...
public class Suggestions {
    ...
    public static void add(String value) {
        ...
        if (value.length() >= suggestionNeededLength) {
            ...
            if (!value.startsWith("#") && !value.endsWith("#")) {
                ...
                if (!Variables.suggestionList.contains(value)) {

                    Variables.suggestionList.add(value);
    ...
    public static void toConsole() {
        ...
        Iterator iterator = Variables.suggestionList.iterator();
