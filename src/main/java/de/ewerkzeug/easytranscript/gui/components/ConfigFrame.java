...
import static de.ewerkzeug.easytranscript.core.Variables.backupTimer;
    ...
    //    prop.setBoolProperty("ConfigPlayerSystemWideCheckbox", ConfigPlayerSystemWideCheckbox.isSelected());
       /* if (!ConfigPlayerSystemWideCheckbox.isSelected()) {
        ...
        try {
            ...
            Variables.logger.log(Level.SEVERE, new ErrorReport().show(errors.getString("SavingConfig2")), e);
